...
<div class="container">
    ...
    <div class="left">
        ...
        <p><b>Birthday:</b> {{ $user->birthday ?? 'December 27, 2004' }}</p>
        <p><b>Age:</b> {{ $user->age ?? '20 years old' }}</p>
        <p><b>Email:</b> {{ $user->email }}</p>
        <p><b>Phone:</b> {{ $user->phone ?? '09551584360' }}</p>
        <p><b>Address:</b> {{ $user->address ?? 'Mapulo, Taysan, Batangas' }}</p>
